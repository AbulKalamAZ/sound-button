...
function InputFormTwo(props) {
  ...
  const handleSwitchChange = (event) => {
    switch (event.target.name) {
      ...
      case "playAnimationInLoop":
        setPlayAnimationInLoop(event.target.checked);
        break;
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={6}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant='h6'>Rotate model by mouse</Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <Grid container spacing={1}>
                      <OrangeSwitch
              ...
              <Grid item xs={12} sm={6}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant='h6'>Play audio on click</Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <Grid container spacing={1}>
                      <OrangeSwitch
              ...
              <Grid item xs={12} sm={6}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant='h6'>Play audio once</Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <OrangeSwitch
              ...
              <Grid item xs={12} sm={6}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant='h6'>Play audio in loop</Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <OrangeSwitch
              ...
              <Grid item xs={12} sm={6}>
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant='h6'>Play animation once</Typography>
                  </Grid>
                  <Grid item xs={12}>
                    <OrangeSwitch
                      checked={playAnimationInLoop}
                      onChange={handleSwitchChange}
                      name='playAnimationInLoop'
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setPlayAnimationInLoop: (payload) =>
      dispatch(buttonActionCreator.setPlayAnimationInLoop(payload)),
