...
class FBXRenderer extends Component {
        ...
        loader.load(models, function (fbx) {
            ...
            animation.load(animationFile, (anim) => {
                ...
                try {
                    ...
                    console.log(
                        'error from animation loader at FBXRenderer.js',
                        err
                    );
                }
            });
    ...
    controlAnimation = () => {
        if (this.state.shouldAnimationPlay) {
            ...
            if (this.state.globalSoundInstance)
                this.state.globalSoundInstance.stop();
            ...
            if (this.state.globalSoundInstance)
                this.state.globalSoundInstance.play();
        ...
        return (
            ...
            >
                <div className="control-button">
                    ...
                    >
                        {this.state.shouldAnimationPlay ? (
                            <PauseIcon />
                        ) : (
                            <PlayArrowIcon />
                        )}
